  ...
  return (
    <section className="bg-gray-200">
      ...
      <div className="relative overflow-hidden group h-[240px] bg-primary card-hidden">
        <img src={pluckingleaves}
          className="h-[240px] transition-all delay-300 duration-400 ease-in w-full absolute group-hover:scale-105 object-cover object-center" alt="text-center Loading" />
      ...
      <div className="text-center bg-gray-200 p-6 rounded-3xl">
        <div className="flex flex-wrap items-center mt-8 text-left">
          <div className="w-full h-full md:w-3/5 lg:w-1/2 px-6">
            <img src={pluckingleaves} alt="agriphoto" className="h-[500px] inline-block shadow-lg border border-merino-400" />
          </div>
          <div className="w-full h-full md:w-2/5 lg:w-1/2 px-6 text-center md:text-left lg:pl-12">
            ...
            Connect farmers and buyers and provide a userfriendly platform to address all needs of both smallhlder
            farmers and large scale agricultural enterprises and unlock the potential of Malawi's agricultural sector and drive economic growth.
            </p>
          </div>
        </div>
      </div>
      <div className="flex flex-wrap items-center mt-8  text-black font-light text-left">
        <div className="w-full h-full md:w-3/5 lg:w-1/2 px-6">
          <img src={onions}
          alt="agriphoto" className="h-[500px] inline-block rounded shadow-lg border border-merino-400" />
        </div>
        <div className="w-full md:w-2/5 lg:w-1/2 px-6 md:order-first text-center md:text-left lg:pr-12">
          ...
          Connect farmers, agricultural dealers, and consumers through a centralized platform and trade with agricultural products with ease and transparency.
          </p>
          <h3 className="font-semibold text-green-500 mt-8 text-xl md:mt-0 sm:text-2xl">Our Vision</h3>
          <p className="text-justify text-2xl sm:text-lg mt-6">
          Prioritize user-friendly and seamless navigation for both farmers, consumers and agricultural dealers. 
          </p>
        </div>
      </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-base">Ensure safe and secure transactions..</p>
              </div>
            </div>
            <div>
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-400 text-white">
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-base">Conducting business with the highest ethical standards..</p>
              </div>
            </div>
            <div>
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-400 text-white">
              {/* <icon={fa-sharp, fa-solid, fa-shield-quartered}> */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round"
              ...
              <div className="mt-5">
                <h3 className="text-lg font-medium text-black">Trustworthiness</h3>
                <p className="mt-2 text-base">Building strong relationships based on reliability.</p>
              </div>
            </div>
          </div>
        </div>
